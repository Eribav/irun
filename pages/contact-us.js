...
import { Barlow_Semi_Condensed, Merriweather } from "next/font/google";
  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-6 px-4 md:px-16 lg:px-32 py-8 md:py-16">
        ...
        {/* lower section */}
        <div className="flex flex-col gap-4">
          <h2 className={`${MerriReg400.className} text-3xl text-center`}>Engage with Us Across our Platform</h2>
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <blockquote className="min-h-32 flex flex-col gap-4 justify-center items-center border border-gray-300 rounded-md shadow-md">
              <FaTwitter className={`text-[${themeColors.strongPink}] text-5xl`} />
              <Link href="https://instagram.com/early_code.net" className="">@earlycodetech</Link>
            </blockquote>
          </div>
        </div>
      </main>
